...
public:
  ...
  //... to compute cell-centered distance
  virtual void VolCenterWidth1(const int k, const int j, const int il, const int iu,
                            AthenaArray<Real> &dx1);
  virtual void VolCenterWidth2(const int k, const int j, const int il, const int iu,
                            AthenaArray<Real> &dx2);
  virtual void VolCenterWidth3(const int k, const int j, const int il, const int iu,
                            AthenaArray<Real> &dx3);
...
public:
  ...
  void VolCenterWidth2(const int k, const int j, const int il, const int iu,
                            AthenaArray<Real> &dx2);
...
public:
  ...
  void VolCenterWidth2(const int k, const int j, const int il, const int iu,
                            AthenaArray<Real> &dx2);
  void VolCenterWidth3(const int k, const int j, const int il, const int iu,
                            AthenaArray<Real> &dx3);
