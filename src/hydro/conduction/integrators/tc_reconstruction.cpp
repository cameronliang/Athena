...
void NTCIntegrator::DonorCellX1(const int k, const int j,
...
void NTCIntegrator::DonorCellX2(const int k, const int j,
  const int il, const int iu, const AthenaArray<Real> &u_tc,
  AthenaArray<Real> &rho, AthenaArray<Real> &tgas, 
  AthenaArray<Real> &rho_l, AthenaArray<Real> &rho_r,
  AthenaArray<Real> &t_l, AthenaArray<Real> &t_r,
...
void NTCIntegrator::DonorCellX3(const int k, const int j,
  const int il, const int iu, const AthenaArray<Real> &u_tc,
  AthenaArray<Real> &rho, AthenaArray<Real> &tgas,  
  AthenaArray<Real> &rho_l, AthenaArray<Real> &rho_r,
  AthenaArray<Real> &t_l, AthenaArray<Real> &t_r,
...
void NTCIntegrator::PieceWiseLinear(const int k, const int j,
...
void NTCIntegrator::GetOneVariableX1(const int k, const int j, 
...
void NTCIntegrator::GetOneVariableX2(const int k, const int j, 
      const int il, const int iu, const AthenaArray<Real> &q, 
      AthenaArray<Real> &ql, AthenaArray<Real> &qr)
{
...
void NTCIntegrator::GetOneVariableX3(const int k, const int j, 
      const int il, const int iu, const AthenaArray<Real> &q, 
      AthenaArray<Real> &ql, AthenaArray<Real> &qr)
{
