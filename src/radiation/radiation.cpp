...
Radiation::Radiation(MeshBlock *pmb, ParameterInput *pin)
{
  ...
  if(nfreq > 1){
    rad_fre_mom.NewAthenaArray(13*nfreq,n3z,n2z,n1z);
    rad_fre_mom_cm.NewAthenaArray(4*nfreq,n3z,n2z,n1z);
  }
  ...
  // equallly weighted frequency for now
...
Radiation::~Radiation()
{
  ...
  if(nfreq > 1){
    rad_fre_mom.DeleteAthenaArray();
    rad_fre_mom_cm.DeleteAthenaArray();
  }
