...
#pragma simd
        for (int i=1; i<=(NGHOST); ++i) {
          u_ntc(n,k,j,is-i) = u_ntc(n,k,j,is);
        }
      }}
    }
  }
...
#pragma simd
        for (int i=1; i<=(NGHOST); ++i) {
          u_ntc(n,k,j,ie+i) = u_ntc(n,k,j,ie);
        }
      }}
    }
  }
...
#pragma simd
      for (int i=is; i<=ie; ++i) {
          u_ntc(n,k,js-j,i) = u_ntc(n,k,js,i);
        }
      }}
    }
  }
...
#pragma simd
      for (int i=is; i<=ie; ++i) {
          u_ntc(n,k,je+j,i) = u_ntc(n,k,je,i);
        }
      }}
    }
  }
...
#pragma simd
      for (int i=is; i<=ie; ++i) {
          u_ntc(n,ks-k,j,i) = u_ntc(n,ks,j,i);
      }
      }}
    }
  }   
...
#pragma simd
      for (int i=is; i<=ie; ++i) {
          u_ntc(n,ke+k,j,i) = u_ntc(n,ke,j,i);
      }
      }}
    }
  }   
