...
#pragma simd
          for (int i=1; i<=(NGHOST); ++i) {
            u_ntc(1,k,j,is-i) = -u_ntc(1,k,j,(is+i-1));  // reflect 1-velocity
          }
        }}
      } else {
        for (int k=ks; k<=ke; ++k) {
...
#pragma simd
          for (int i=1; i<=(NGHOST); ++i) {
            u_ntc(n,k,j,is-i) = u_ntc(n,k,j,(is+i-1));
          }
        }}
      }
    }
...
#pragma simd
          for (int i=1; i<=(NGHOST); ++i) {
            u_ntc(1,k,j,ie+i) = -u_ntc(1,k,j,(ie-i+1));  // reflect 1-velocity
          }
        }}
      } else {
        for (int k=ks; k<=ke; ++k) {
...
#pragma simd
          for (int i=1; i<=(NGHOST); ++i) {
            u_ntc(n,k,j,ie+i) = u_ntc(n,k,j,(ie-i+1));
          }
        }}
      }
    }
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(2,k,js-j,i) = -u_ntc(2,k,(js+j-1),i);  // reflect 1-velocity
          }
        }}
      } else {
        for (int k=ks; k<=ke; ++k) {
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(n,k,js-j,i) = u_ntc(n,k,(js+j-1),i);
          }
        }}
      }
    }
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(2,k,je+j,i) = -u_ntc(2,k,(je-j+1),i);  // reflect 1-velocity
          }
        }}
      } else {
        for (int k=ks; k<=ke; ++k) {
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(n,k,je+j,i) = u_ntc(n,k,(je-j+1),i);
          }
        }}
      }
    }
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(3,ks-k,j,i) = -u_ntc(3,ks+k-1,j,i);  // reflect 1-velocity
          }
        }}
      } else {
        for (int k=1; k<=(NGHOST); ++k) {
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(n,ks-k,j,i) = u_ntc(n,ks+k-1,j,i);
          }
        }}
      }
    }
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(3,ke+k,j,i) = -u_ntc(3,ke-k+1,j,i);  // reflect 1-velocity
          }
        }}
      } else {
        for (int k=1; k<=(NGHOST); ++k) {
...
#pragma simd
          for (int i=is; i<=ie; ++i) {
            u_ntc(n,ke+k,j,i) = u_ntc(n,ke-k+1,j,i);
          }
        }}
      }
    }
