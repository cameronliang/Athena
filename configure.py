...
parser.add_argument('-ntc',
    action='store_true',
    default=False,
    help='enable new thermal conduction')
...
if args['cr']:
  makefile_options['CR_FILE'] = '*.cpp'
  definitions['NCR_VARIABLES'] = '4'
else:
  makefile_options['CR_FILE'] = '*.cpp'
  definitions['NCR_VARIABLES'] = '0'

# -new thermal conduction argument
definitions['NEW_TH_CON_ENABLED'] = '1' if args['ntc'] else '0'
if args['ntc']:
  makefile_options['NTC_FILE'] = '*.cpp'
  definitions['NTC_VARIABLES'] = '3'
else:
  makefile_options['CR_FILE'] = '*.cpp'
  definitions['NTC_VARIABLES'] = '0'
...
print('  New Thermal Conduction:  ' + ('ON' if args['ntc'] else 'OFF'))
...
flog.write('  New Thermal Conduction:  ' + ('ON' if args['ntc'] else 'OFF') + '\n')
